...
values
    (${investigationSentId5}, ''   , ${bpnOwn}, null        , current_timestamp - interval '5 days', 'Investigation on Electric Fuse big due to broken wire.', 'DECLINED', 'SENDER', null         , 'It''s not broken', current_timestamp - interval '1 hour', 'INVESTIGATION');
...
values
    (${investigationNotificationSentId5a}, ${investigationSentId5}, 'contractAgreementId', 'http://localhost:5001/edc', null                     , ${bpnOwn} , ${bpnSupplier3}, current_timestamp + interval '2 weeks', 'MAJOR' , ${bpnOwnName}  , ${bpnSupplier3Name}, '3ac2239a-e63f-4c19-b3b3-e6a2e5a240da', 'DECLINED', current_timestamp - interval '5 days', current_timestamp - interval '1 hour', '749b31e9-9e73-4699-9470-dbee67ebc7a7', true      , null);

...
values
    (${investigationSentId5}, ${bpnOwn}, null        , current_timestamp - interval '5 days', 'Investigation on Electric Fuse big due to broken wire.', 'DECLINED', 'SENDER', null         , 'It''s not broken', current_timestamp - interval '1 hour');
...
values
    (${investigationNotificationSentId5a}, 'contractAgreementId', null                     , ${bpnOwn} , ${bpnSupplier3}, ${investigationSentId5}, current_timestamp + interval '2 weeks', 'MAJOR' , ${bpnOwnName}  , ${bpnSupplier3Name}, '3ac2239a-e63f-4c19-b3b3-e6a2e5a240da', 'DECLINED', current_timestamp - interval '5 days', current_timestamp - interval '1 hour', '749b31e9-9e73-4699-9470-dbee67ebc7a7', null);
...
insert into investigation_notification
    (id                                  , contract_agreement_id, notification_reference_id, created_by     , send_to  , investigation_id       , target_date                           , severity, created_by_name    , send_to_name , edc_notification_id                   , status    , created                              , updated                              , message_id                            , error_message)
values
    (${investigationNotificationSentId5b}, 'contractAgreementId', null                     , ${bpnSupplier3}, ${bpnOwn}, ${investigationSentId5}, current_timestamp + interval '2 weeks', 'MAJOR' , ${bpnSupplier3Name}, ${bpnOwnName}, '8925f21f-09eb-4789-81fb-ec221e9e1561', 'DECLINED', current_timestamp - interval '5 days', current_timestamp - interval '1 hour', '207ba6cf-217b-401d-a5da-69cac8b154a5', null);

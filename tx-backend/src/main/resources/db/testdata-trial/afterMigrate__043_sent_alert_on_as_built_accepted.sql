...
values
    (${alertSentId4}, ''   , ${bpnOwn}, null        , current_timestamp - interval '5 days', 'Alert about Control Unit big', 'ACCEPTED', 'SENDER', 'Thanks for letting us know. We''ll check', null          , null   , 'ALERT');

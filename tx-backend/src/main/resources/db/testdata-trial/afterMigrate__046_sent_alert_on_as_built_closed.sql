...
values
    (${alertSentId7}                , ''                                    , ${bpnOwn}            , 'This was a false alarm'   , current_timestamp - interval '2 days' , 'Closed Alert about Right Headlight', 'CLOSED'       , 'SENDER'                              , null         , null           , null               , 'ALERT'  );
...
values
    (${alertNotificationSentId7a}   , ${alertSentId7}                       , 'contractAgreementId', 'http://localhost:5001/edc', 'null'                                , ${bpnOwn}                           , ${bpnCustomer1}, current_timestamp + interval '1 month', 'CRITICAL'   , ${bpnOwnName}  , ${bpnCustomer1Name}, ${alertNotificationSentId7a}          , 'CLOSED', current_timestamp - interval '2 days', current_timestamp                      , '3ca2e271-bffb-4e34-83c5-13fc1c462062', true      , null);

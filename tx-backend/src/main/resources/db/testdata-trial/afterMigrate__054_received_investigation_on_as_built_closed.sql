...
values
    (${investigationReceivedId5}             , ''                                    , ${bpnCustomer2}            , 'We confirm that the problem has been fixed.', current_timestamp - interval '5 days', 'Investigation on Turn Light due to malfunction.', 'CLOSED'                   , 'RECEIVER'                            , null         , null               , current_timestamp - interval '1 hours', 'INVESTIGATION');
...
values
    (${investigationNotificationReceivedId5a},${investigationReceivedId5}, null                                  , null                       , '8925f21f-09eb-4789-81fb-ec221e9e1561'       , ${bpnCustomer1}                      , ${bpnOwn}                                        ,  current_timestamp + interval '1 month', 'MINOR'      , ${bpnCustomer1Name}, ${bpnOwnName}                         , '8925f21f-09eb-4789-81fb-ec221e9e1561', 'CLOSED', current_timestamp - interval '5 days' , current_timestamp - interval '2 hours', 'e04f75e8-d37b-42e4-8cf7-6127f35f3ed5', false     , null);
...
insert into notification_message
    (id                                      , notification_id                       , contract_agreement_id      , edc_url                                      , notification_reference_id            , created_by                                       , send_to                    , target_date                           , severity     , created_by_name    , send_to_name                          , edc_notification_id                   , status  , created                               , updated                               , message_id                            , is_initial, error_message)
values
    (${investigationNotificationReceivedId5b}, ${investigationReceivedId5},'contractAgreementId'                 , 'http://localhost:5001/edc', null                                         , ${bpnCustomer1}                      , ${bpnOwn}                                        ,  current_timestamp + interval '1 month', 'MINOR'      , ${bpnCustomer1Name}, ${bpnOwnName}                         , '8925f21f-09eb-4789-81fb-ec221e9e1561', 'CLOSED', current_timestamp - interval '5 days ', current_timestamp - interval '1 hour' , '207ba6cf-217b-401d-a5da-69cac8b154a5', false     , null);

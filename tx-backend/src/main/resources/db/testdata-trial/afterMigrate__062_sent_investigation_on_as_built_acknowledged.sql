...
values
    (${investigationSentId3}, ''   , ${bpnOwn}, null        , current_timestamp - interval '3 days', 'Investigation on Left Xenon Gland due to occasional outages.', 'ACKNOWLEDGED', 'SENDER', null         , null          , current_timestamp - interval '1 hour', 'INVESTIGATION');

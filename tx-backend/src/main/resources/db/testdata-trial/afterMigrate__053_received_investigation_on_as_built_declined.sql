...
values
    (${investigationReceivedId4}, ${bpnCustomer2}, null        , current_timestamp - interval '4 days', 'Investigation on Control Unit big due to malfunction.', 'DECLINED', 'RECEIVER', null         , 'Everything works fine', current_timestamp - interval '1 hours');

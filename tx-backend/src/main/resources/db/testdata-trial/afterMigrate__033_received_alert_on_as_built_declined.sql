...
values
    (${alertReceivedId4}             , ''                                    , ${bpnSupplier3}      , null                       , current_timestamp - interval '5 days' , 'Alert about Electric Fuse Small', 'DECLINED'     , 'RECEIVER'                            , null         , 'Not relevant for us', null               , 'ALERT');

...
values
    (${investigationReceivedId3}, ${bpnCustomer2}, null        , current_timestamp - interval '3 days', 'Investigation on Control Unit small due to malfunction.', 'ACCEPTED', 'RECEIVER', 'True, it doesn''t work', null          , current_timestamp - interval '1 hours');

...
values
    (${investigationSentId2}            , ''                                    , ${bpnOwn}                  , null        , current_timestamp - interval '2 days', 'Investigation on Right Headbulb due to excessive brightness.', 'SENT'                 , 'SENDER'                             , null         , null           , current_timestamp - interval '1 hour', 'INVESTIGATION');

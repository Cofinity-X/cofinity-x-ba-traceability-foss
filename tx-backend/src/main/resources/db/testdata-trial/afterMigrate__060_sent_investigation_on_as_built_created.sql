...
values
    (${investigationSentId1}, ${bpnOwn}, null        , current_timestamp - interval '1 day', 'Investigation on Left Headbulb due to excessive brightness.', 'CREATED', 'SENDER', null         , null          , null   );

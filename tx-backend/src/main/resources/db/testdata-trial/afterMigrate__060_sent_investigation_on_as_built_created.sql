...
values
    (${investigationNotificationSentId1}, null                 , null   , null                     , ${bpnOwn} , ${bpnSupplier1}, ${investigationSentId1}, current_timestamp + interval '1 week', 'CRITICAL', ${bpnOwnName}  , ${bpnSupplier1Name}, 'c01353db-640a-44c4-9a87-28fa3a950a95', 'CREATED', current_timestamp - interval '1 day', current_timestamp - interval '1 hour', '71d7cb88-a208-434b-993e-74aeb331fd11', true);

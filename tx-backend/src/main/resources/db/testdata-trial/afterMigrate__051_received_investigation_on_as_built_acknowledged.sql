...
values
    (${investigationReceivedId2}, ''   , ${bpnCustomer1}, null        , current_timestamp - interval '2 days', 'Investigation on Right Headlight due to malfunction.', 'ACKNOWLEDGED', 'RECEIVER', null         , null          , current_timestamp - interval '1 hours', 'INVESTIGATION');

...
insert into alert_notification
    (id                          , alert_id       , contract_agreement_id, edc_url, notification_reference_id             , created_by     , send_to  , target_date                           , severity, created_by_name    , send_to_name , edc_notification_id                   , status    , created                              , updated                                , message_id, is_initial)
values
    (${alertNotificationSentId5b}, ${alertSentId5}, null                 , null   , 'fe40ca1c-0d4d-4af0-9ccc-415113f4b7a1', ${bpnCustomer2}, ${bpnOwn}, current_timestamp + interval '2 weeks', 'MAJOR' , ${bpnCustomer2Name}, ${bpnOwnName}, 'fe40ca1c-0d4d-4af0-9ccc-415113f4b7a1', 'DECLINED', current_timestamp - interval '2 days', current_timestamp - interval '12 hours', null      , false);

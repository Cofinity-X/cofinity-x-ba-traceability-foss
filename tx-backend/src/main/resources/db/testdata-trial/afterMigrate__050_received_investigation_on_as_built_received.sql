...
values
    (${investigationNotificationReceivedId1}, null                                  , null                 , '8925f21f-09eb-4789-81fb-ec221e9e1561', ${bpnCustomer1}                     , ${bpnOwn}                                            , ${investigationReceivedId1}, current_timestamp + interval '2 weeks', 'MAJOR'      , ${bpnCustomer1Name}, ${bpnOwnName}, '8925f21f-09eb-4789-81fb-ec221e9e1561', 'RECEIVED', current_timestamp - interval '1 day', current_timestamp - interval '2 hours', 'e04f75e8-d37b-42e4-8cf7-6127f35f3ed5', false     , null);

...
values
    (${alertReceivedId5}             , ''                                    , ${bpnSupplier2}      , 'Issue has been resolved'  , current_timestamp - interval '6 days' , 'Alert about Electric Fuse Big', 'CLOSED' , 'RECEIVER'                            , null         , null               , null         , 'ALERT');

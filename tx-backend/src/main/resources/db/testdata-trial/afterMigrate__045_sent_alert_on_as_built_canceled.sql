...
values
    (${alertSentId6}, ''   , ${bpnOwn}, null        , current_timestamp - interval '3 days', 'Cancelled Alert about Break Light', 'CANCELED', 'SENDER', null         , null          , null   , 'ALERT'  );

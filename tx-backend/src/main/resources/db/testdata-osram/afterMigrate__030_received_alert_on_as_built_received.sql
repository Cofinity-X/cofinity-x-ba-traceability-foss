...
values
    (${alertReceivedId1}, ''   , ${bpnSupplier21}, null        , current_timestamp - interval '2 days', 'Alert about Packaging for turning light', 'RECEIVED', 'RECEIVER', null         , null          , null   , 'ALERT'  );

...
values
    (${alertReceivedId2}             , ''                                    , ${bpnSupplier2}      , null        , current_timestamp - interval '3 days' , 'Alert about Right P Light Bulbs', 'ACKNOWLEDGED' , 'RECEIVER'                            , null              , null               , null               , 'ALERT' );
...
(id                                  , notification_id                       , contract_agreement_id, edc_url     , notification_reference_id             , created_by                       , send_to        , target_date                           , severity          , created_by_name    , send_to_name       , edc_notification_id                   , status        , created                                , updated                                , message_id, is_initial, error_message)
values
    (${alertNotificationReceivedId2b}, ${alertReceivedId2}                   , null                 , null        , '403818ab-28fc-428f-99b1-61077fede954', ${bpnOwn}                        , ${bpnSupplier2}, current_timestamp + interval '1 month', 'LIFE_THREATENING', ${bpnOwnName}      , ${bpnSupplier2Name}, '403818ab-28fc-428f-99b1-61077fede954', 'ACKNOWLEDGED', current_timestamp - interval '12 hours', current_timestamp - interval '12 hours', null      , false     , null);

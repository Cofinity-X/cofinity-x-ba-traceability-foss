...
values
    (${alertSentId5}               , ''                                    , ${bpnOwn}            , null        , current_timestamp - interval '4 days' , 'Alert about High beam left', 'DECLINED'     , 'SENDER'                              , null         , 'Thanks, but this doesn''t affect us', null               , 'ALERT'  );
...
values
    (${alertNotificationSentId5a}  , ${alertSentId5}                       , null                 , null        , 'null'                                , ${bpnOwn}                   , ${bpnCustomer3}, current_timestamp + interval '2 weeks', 'MAJOR'      , ${bpnOwnName}                        , ${bpnCustomer3Name}, 'fe40ca1c-0d4d-4af0-9ccc-415113f4b7a1', 'CREATED' , current_timestamp - interval '4 days', current_timestamp                      , null      , true      , null);
...
insert into notification_message
    (id                            , notification_id                       , contract_agreement_id, edc_url     , notification_reference_id             , created_by                  , send_to        , target_date                           , severity     , created_by_name                      , send_to_name       , edc_notification_id                   , status    , created                              , updated                                , message_id, is_initial, error_message)
values
    (${alertNotificationSentId5b}  , ${alertSentId5}                       , null                 , null        , 'fe40ca1c-0d4d-4af0-9ccc-415113f4b7a1', ${bpnCustomer3}             , ${bpnOwn}      , current_timestamp + interval '2 weeks', 'MAJOR'      , ${bpnCustomer3Name}                  , ${bpnOwnName}      , 'fe40ca1c-0d4d-4af0-9ccc-415113f4b7a1', 'DECLINED', current_timestamp - interval '2 days', current_timestamp - interval '12 hours', null      , false     , null);

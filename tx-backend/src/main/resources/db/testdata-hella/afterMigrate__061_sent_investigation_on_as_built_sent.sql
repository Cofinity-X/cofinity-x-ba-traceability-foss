...
values
    (${investigationSentId2}, ${bpnOwn}, null        , current_timestamp - interval '2 days' , 'Investigation on Osram Front Right-AX400 due to excessive brightness.', 'SENT', 'SENDER', null         , null          , current_timestamp - interval '1 hour', null);

...
values
    (${alertNotificationReceivedId4a}, ${alertReceivedId4}, null                 , null   , 'cc49777f-3c8b-47d6-b1cf-f51783737292', ${bpnSupplier3}, ${bpnOwn}, current_timestamp + interval '1 month', 1       , 'Würth'        , 'Hella'     , 'cc49777f-3c8b-47d6-b1cf-f51783737292', 2     , current_timestamp - interval '4 days', current_timestamp, '68ebeb5f-158d-480e-b466-24304842c22c', false);

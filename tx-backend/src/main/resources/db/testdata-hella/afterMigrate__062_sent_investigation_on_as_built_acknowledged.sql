...
values
    (${investigationNotificationSentId3a}, 'contractAgreementId', 'http://localhost:8082/api/qualitynotifications/receive', null                     , ${bpnOwn} , ${bpnSupplier2}, ${investigationSentId3}, current_timestamp + interval '4 days', 3       , 'Hella'        , 'Philips'   , '3ac2239a-e63f-4c19-b3b3-e6a2e5a240da', 3     , current_timestamp - interval '3 days', current_timestamp - interval '1 hour', '749b31e9-9e73-4699-9470-dbee67ebc7a7', true);
...
insert into investigation_notification
    (id                                  , contract_agreement_id, edc_url                                                 , notification_reference_id, created_by     , send_to  , investigation_id       , target_date                          , severity, created_by_name, send_to_name, edc_notification_id                   , status , created                              , updated                              , message_id                            , is_initial)
values
    (${investigationNotificationSentId3b}, 'contractAgreementId', 'http://localhost:8082/api/qualitynotifications/receive', null                     , ${bpnSupplier2}, ${bpnOwn}, ${investigationSentId3}, current_timestamp + interval '4 days', 3       , 'Philips'      , 'Hella'     , '8925f21f-09eb-4789-81fb-ec221e9e1561', 3      , current_timestamp - interval '3 days', current_timestamp - interval '1 hour', '207ba6cf-217b-401d-a5da-69cac8b154a5', false);

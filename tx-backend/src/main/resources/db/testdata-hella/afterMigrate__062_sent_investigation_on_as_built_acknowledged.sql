...
values
    (${investigationSentId3}             , ''                                    , ${bpnOwn}            , null        , current_timestamp - interval '3 days' , 'Investigation on Philips P-LeftHeadBulb due to occasional outages.', 'ACKNOWLEDGED' , 'SENDER'                             , null              , null               , current_timestamp - interval '1 hour', 'INVESTIGATION');
...
values
    (${investigationNotificationSentId3a}, ${investigationSentId3}               , 'contractAgreementId', null        , null                                  , ${bpnOwn}                                                           , ${bpnSupplier2}, current_timestamp + interval '4 days', 'LIFE_THREATENING', ${bpnOwnName}      , ${bpnSupplier2Name}                  , '5679b6fe-7463-4439-9e87-7f8622d57c22', 'ACKNOWLEDGED', current_timestamp - interval '3 days', current_timestamp - interval '1 hour', null      , true      , null);
...
insert into notification_message
    (id                                  , notification_id                       , contract_agreement_id, edc_url     , notification_reference_id             , created_by                                                          , send_to        , target_date                          , severity          , created_by_name    , send_to_name                         , edc_notification_id                   , status        , created                              , updated                              , message_id, is_initial, error_message)
values
    (${investigationNotificationSentId3b}, ${investigationSentId3}               , 'contractAgreementId', null        , '5679b6fe-7463-4439-9e87-7f8622d57c22', ${bpnSupplier2}                                                     , ${bpnOwn}      , current_timestamp + interval '4 days', 'LIFE_THREATENING', ${bpnSupplier2Name}, ${bpnOwnName}                        , '5679b6fe-7463-4439-9e87-7f8622d57c22', 'ACKNOWLEDGED', current_timestamp - interval '2 days', null                                 , null      , false     , null);

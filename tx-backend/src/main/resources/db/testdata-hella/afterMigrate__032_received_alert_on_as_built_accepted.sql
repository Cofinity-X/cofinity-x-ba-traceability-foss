...
values
    (${alertReceivedId3}             , ''                                    , ${bpnSupplier2}      , null        , current_timestamp - interval '4 days' , 'Alert about P-TurningLight', 'ACCEPTED'     , 'RECEIVER'                            , 'Part has been replaced', null               , null               , 'ALERT'  );
...
values
    (${alertNotificationReceivedId3a}, ${alertReceivedId3}                   , null                 , null        , 'be320b81-01ab-46fd-baf5-4e182978c31e', ${bpnSupplier2}             , ${bpnOwn}      , current_timestamp + interval '1 month', 'MINOR'                 , ${bpnSupplier2Name}, ${bpnOwnName}      , 'c7968bc9-22d0-48d8-8269-10a9043fcf47', 'RECEIVED', current_timestamp - interval '3 days'  , current_timestamp                      , '68ebeb5f-158d-480e-b466-24304842c22c', false     , null);

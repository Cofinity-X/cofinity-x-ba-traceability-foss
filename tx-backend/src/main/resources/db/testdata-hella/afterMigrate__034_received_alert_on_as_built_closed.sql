...
values
    (${alertReceivedId5}             , ''                                    , ${bpnSupplier2}      , 'Issue has been resolved', current_timestamp - interval '6 days' , 'Alert about P-BrakeLight', 'CLOSED' , 'RECEIVER'                            , null         , null               , null         , 'ALERT' );
...
values
    (${alertNotificationReceivedId5a}, ${alertReceivedId5}                   , null                 , null                     , '9c1290e1-7292-42fc-aef3-16f384e0bc76', ${bpnSupplier2}           , ${bpnOwn}, current_timestamp + interval '1 month', 'CRITICAL'   , ${bpnSupplier2Name}, ${bpnOwnName}, '01d08ee0-ee35-48ca-90ae-e4eea05dba92', 'CLOSED', current_timestamp - interval '5 days'  , current_timestamp                      , '68ebeb5f-158d-480e-b466-24304842c22c', false     , null);

...
values
    (${investigationSentId1}            , ''                                    , ${bpnOwn}            , null        , current_timestamp - interval '1 day', 'Investigation on Osram Front Left-AX400 due to excessive brightness.', 'CREATED'      , 'SENDER'                             , null         , null           , null               , 'INVESTIGATION'  );
...
values
    (${investigationNotificationSentId1}, ${investigationSentId1}               , null                 , null        , null                                , ${bpnOwn}                                                             , ${bpnSupplier1}, current_timestamp + interval '1 week', 'CRITICAL'   , ${bpnOwnName}  , ${bpnSupplier1Name}, 'c01353db-640a-44c4-9a87-28fa3a950a95', 'CREATED', current_timestamp - interval '1 day', current_timestamp - interval '1 hour', '71d7cb88-a208-434b-993e-74aeb331fd11', true      , null);

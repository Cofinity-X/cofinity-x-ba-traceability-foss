...
values
    (${investigationReceivedId4}             , ''                                    , ${bpnCustomer2}      , null        , current_timestamp - interval '4 days' , 'Investigation on H-LeftBrakeLight due to malfunction.', 'DECLINED'     , 'RECEIVER'                           , null              , 'Everything works fine', current_timestamp - interval '1 hours', 'INVESTIGATION');
...
insert into notification_message
    (id                                      , notification_id                       , contract_agreement_id, edc_url     , notification_reference_id             , created_by                                             , send_to        , target_date                          , severity          , created_by_name        , send_to_name                          , edc_notification_id                   , status    , created                              , updated                               , message_id                            , is_initial, error_message)
values
    (${investigationNotificationReceivedId4b}, ${investigationReceivedId4}           , 'contractAgreementId', null        , null                                  , ${bpnOwn}                                              , ${bpnCustomer2}, current_timestamp + interval '3 days', 'LIFE_THREATENING', ${bpnOwnName}          , ${bpnCustomer2Name}                   , '8925f21f-09eb-4789-81fb-ec221e9e1561', 'DECLINED', current_timestamp - interval '4 days', current_timestamp - interval '1 hour' , '207ba6cf-217b-401d-a5da-69cac8b154a5', false     , null);

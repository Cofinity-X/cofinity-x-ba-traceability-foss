...
values
    (${investigationSentId7}             , ''                                    , ${bpnOwn}            , 'Problem is fixed', current_timestamp - interval '6 days', 'Investigation on Philips RightHeadBulb due to broken fuse.', 'CLOSED'       , 'SENDER'                             , null         , null           , current_timestamp - interval '1 hour', 'INVESTIGATION');
...
values
    (${investigationNotificationSentId7a}, ${investigationSentId7}               , 'contractAgreementId', null              , null                                 , ${bpnOwn}                                                   , ${bpnSupplier2}, current_timestamp + interval '1 week', 'CRITICAL'   , ${bpnOwnName}  , ${bpnSupplier2Name}                  , '3ac2239a-e63f-4c19-b3b3-e6a2e5a240da', 'CANCELED', current_timestamp - interval '6 days', current_timestamp - interval '1 hour', '749b31e9-9e73-4699-9470-dbee67ebc7a7', true      , null);
...
insert into notification_message
    (id                                  , notification_id                       , contract_agreement_id, edc_url           , notification_reference_id            , created_by                                                  , send_to        , target_date                          , severity     , created_by_name, send_to_name                         , edc_notification_id                   , status    , created                              , updated                              , message_id                            , is_initial, error_message)
values
    (${investigationNotificationSentId7b}, ${investigationSentId7}               , 'contractAgreementId', null              , null                                 , ${bpnOwn}                                                   , ${bpnSupplier2}, current_timestamp + interval '1 week', 'CRITICAL'   , ${bpnOwnName}  , ${bpnSupplier2Name}                  , '8925f21f-09eb-4789-81fb-ec221e9e1561', 'CANCELED', current_timestamp - interval '6 days', current_timestamp - interval '1 hour', '207ba6cf-217b-401d-a5da-69cac8b154a5', false     , null);

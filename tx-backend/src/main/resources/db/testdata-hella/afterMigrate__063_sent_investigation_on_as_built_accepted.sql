...
values
    (${investigationSentId4}, ${bpnOwn}, null        , current_timestamp - interval '4 days', 'Investigation on Würth W-FogLight due to damaged packaging.', 'ACCEPTED', 'SENDER', 'Damn, it''s damaged!', null          , current_timestamp - interval '1 hour');

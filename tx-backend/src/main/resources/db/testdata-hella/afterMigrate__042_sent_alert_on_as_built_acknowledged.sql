...
values
    (${alertSentId3}               , ''                                    , ${bpnOwn}            , null        , current_timestamp - interval '1 day'  , 'Alert about Brake lights left', 'ACKNOWLEDGED' , 'SENDER'   , null              , null               , null               , 'ALERT'   );
...
insert into notification_message
    (id                            , notification_id                       , contract_agreement_id, edc_url     , notification_reference_id             , created_by                     , send_to        , target_date, severity          , created_by_name    , send_to_name       , edc_notification_id                   , status        , created                                , updated                                , message_id, is_initial, error_message)
 values
    (${alertNotificationSentId3b}  , ${alertSentId3}                       , 'contractAgreementId', null        , '7354895f-9e79-4582-af35-7d5b820ac9b6', ${bpnCustomer2}                , ${bpnOwn}      , null       , 'LIFE_THREATENING', ${bpnCustomer2Name}, ${bpnOwnName}      , '7354895f-9e79-4582-af35-7d5b820ac9b6', 'ACKNOWLEDGED', current_timestamp - interval '12 hours', current_timestamp - interval '12 hours', null      , true      , null);

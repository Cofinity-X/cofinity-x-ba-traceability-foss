...
values
    (${alertSentId2}               , ''                                    , ${bpnOwn}            , null        , current_timestamp - interval '1 day', 'First Alert about Left Headlights', 'SENT'         , 'SENDER'                             , null         , null           , current_timestamp  , 'ALERT');
...
values
    (${alertNotificationSentId2}   , ${alertSentId2}                       , 'contractAgreementId', 'null'      , null                                , ${bpnOwn}                          , ${bpnCustomer1}, current_timestamp + interval '1 week', 'MAJOR'      , ${bpnOwnName}  , ${bpnCustomer1Name}, ${alertNotificationSentId2}, 'CREATED', current_timestamp - interval '1 day', current_timestamp, '2cf84b7c-5e42-46f2-8869-12b053b9a276', true      , null);

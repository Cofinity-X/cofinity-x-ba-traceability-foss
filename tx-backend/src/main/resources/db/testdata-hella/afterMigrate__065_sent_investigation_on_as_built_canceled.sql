...
values
    (${investigationSentId6}            , ''                                    , ${bpnOwn}            , null        , current_timestamp - interval '7 days', 'Investigation on Osram O-BrakeLight due to strange noise.', 'CANCELED'     , 'SENDER'                             , null              , null           , current_timestamp - interval '1 hour', 'INVESTIGATION');
...
values
    (${investigationNotificationSentId6}, ${investigationSentId6}               , 'contractAgreementId', null        , null                                 , ${bpnOwn}                                                  , ${bpnSupplier1}, current_timestamp + interval '2 days', 'LIFE_THREATENING', ${bpnOwnName}  , ${bpnSupplier1Name}                  , '3ac2239a-e63f-4c19-b3b3-e6a2e5a240da', 'CLOSED', current_timestamp - interval '7 days', current_timestamp - interval '1 hour', '749b31e9-9e73-4699-9470-dbee67ebc7a7', true      , null);

...
values
    (${investigationReceivedId2}             , ''                                    , ${bpnCustomer1}      , null        , current_timestamp - interval '2 days' , 'Investigation on Xenon Right-Headlights due to malfunction.', 'ACKNOWLEDGED' , 'RECEIVER'                            , null         , null               , current_timestamp - interval '1 hours', 'INVESTIGATION');
...
values
    (${investigationNotificationReceivedId2a}, ${investigationReceivedId2}           , null                 , null        , 'c422e2a7-d037-499c-9ec2-44e3bc4f5815', ${bpnCustomer1}                                              , ${bpnOwn}      , current_timestamp + interval '1 month', 'MINOR'      , ${bpnCustomer1Name}, ${bpnOwnName}                         , 'c422e2a7-d037-499c-9ec2-44e3bc4f5815', 'RECEIVED'    , current_timestamp - interval '2 days'                    , current_timestamp - interval '2 hours', null      , false     , null);
...
insert into notification_message
    (id                                      , notification_id                       , contract_agreement_id, edc_url     , notification_reference_id             , created_by                                                   , send_to        , target_date                           , severity     , created_by_name    , send_to_name                          , edc_notification_id                   , status        , created                                                  , updated                               , message_id, is_initial, error_message)
values
    (${investigationNotificationReceivedId2b}, ${investigationReceivedId2}           , 'contractAgreementId', null        , null                                  , ${bpnOwn}                                                    , ${bpnCustomer1}, current_timestamp + interval '1 month', 'MINOR'      , ${bpnOwnName}      , ${bpnCustomer1Name}                   , 'c422e2a7-d037-499c-9ec2-44e3bc4f5815', 'ACKNOWLEDGED', current_timestamp - interval '2 days' + interval '1 hour', current_timestamp - interval '1 hour' , null      , false     , null);

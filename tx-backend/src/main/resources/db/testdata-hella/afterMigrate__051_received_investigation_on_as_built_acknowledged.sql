...
values
    (${investigationReceivedId2}, ${bpnCustomer1}, null        , current_timestamp - interval '2 days', 'Investigation on Xenon Right-Headlights due to malfunction.', 'ACKNOWLEDGED', 'RECEIVER', null         , null          , current_timestamp - interval '1 hours');
...
values
    (${investigationNotificationReceivedId2a}, null                 , 'c422e2a7-d037-499c-9ec2-44e3bc4f5815', ${bpnCustomer1}, ${bpnOwn}, ${investigationReceivedId2}, current_timestamp + interval '1 month', 'MINOR' , ${bpnCustomer1Name}, ${bpnOwnName}, 'c422e2a7-d037-499c-9ec2-44e3bc4f5815', 'RECEIVED', current_timestamp - interval '2 days', current_timestamp - interval '2 hours', null      , null);
...
insert into investigation_notification
    (id                                      , contract_agreement_id, notification_reference_id, created_by, send_to        , investigation_id           , target_date                           , severity, created_by_name, send_to_name       , edc_notification_id                   , status        , created                                                  , updated                              , message_id, error_message)
values
    (${investigationNotificationReceivedId2b}, 'contractAgreementId', null                     , ${bpnOwn} , ${bpnCustomer1}, ${investigationReceivedId2}, current_timestamp + interval '1 month', 'MINOR' , ${bpnOwnName}  , ${bpnCustomer1Name}, 'c422e2a7-d037-499c-9ec2-44e3bc4f5815', 'ACKNOWLEDGED', current_timestamp - interval '2 days' + interval '1 hour', current_timestamp - interval '1 hour', null      , null);

...
values
    (${alertReceivedId1}            , ''                                    , ${bpnSupplier1}      , null        , current_timestamp - interval '2 days' , 'Alert about Left O Light Bulbs', 'RECEIVED', 'RECEIVER'                            , null         , null               , null         , 'ALERT');

...
values
    (${alertSentId5}, 'BPNL000000000001', null         , current_timestamp - interval '4 days', 'Alert about High beam left', 'DECLINED', 'SENDER', null         , 'Thanks, but this doesn''t affect us'          , current_timestamp, null);
...
values
    (${alertNotificationSentId5a}, ${alertSentId5}, 'contractAgreementId', 'http://localhost:8082/api/qualitynotifications/receive', 'null'                   , 'BPNL000000000001', 'BPNL000CUSTOMER3', current_timestamp + interval '2 weeks', 1       , 'Hella'        , 'VW AG'    , ${alertNotificationSentId5a}, 0     , current_timestamp - interval '4 days', current_timestamp, '2cf84b7c-5e42-46f2-8869-12b053b9a276', true);

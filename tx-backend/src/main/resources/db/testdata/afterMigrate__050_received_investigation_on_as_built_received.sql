...
values
    (${investigationReceivedId1}, 'BPNL000CUSTOMER1', null        , current_timestamp - interval '1 day', 'Investigation on Xenon Left-Headlights due to malfunction.', 'RECEIVED', 'RECEIVER', null         , null          , null   , null);
...
values
    (${investigationNotificationReceivedId1}, null                 , null   , '8925f21f-09eb-4789-81fb-ec221e9e1561', 'BPNL000000000001', 'BPNL000CUSTOMER1', ${investigationReceivedId1}, current_timestamp + interval '2 weeks', 1       , 'BMW AG'       , 'Hella'     , '8925f21f-09eb-4789-81fb-ec221e9e1561', '2'   , current_timestamp - interval '1 day', current_timestamp - interval '2 hours', 'e04f75e8-d37b-42e4-8cf7-6127f35f3ed5', false);

...
values
    (${investigationSentId5}, 'BPNL000000000001', null        , current_timestamp - interval '5 days', 'Investigation on Würth W-HighBeam due to broken glass.', 'DECLINED', 'SENDER', null          , 'It''s not broken' , current_timestamp - interval '1 hour', null);

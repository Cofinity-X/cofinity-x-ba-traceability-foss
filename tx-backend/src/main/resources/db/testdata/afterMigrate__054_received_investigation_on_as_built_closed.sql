...
values
    (${investigationReceivedId5}, 'BPNL000CUSTOMER3', 'We confirm that the problem has been fixed.' , current_timestamp - interval '5 days', 'Investigation on H-LeftFogLight due to malfunction.', 'CLOSED', 'RECEIVER', null         , null           , current_timestamp - interval '1 hours', null);
...
values
    (${investigationNotificationReceivedId5a}, null                 , null   , '8925f21f-09eb-4789-81fb-ec221e9e1561', 'BPNL000000000001', 'BPNL000CUSTOMER3', ${investigationReceivedId5}, current_timestamp + interval '1 month', 0       , 'VW AG'       , 'Hella'     , '8925f21f-09eb-4789-81fb-ec221e9e1561', '7'    , current_timestamp - interval '5 days', current_timestamp - interval '2 hours', 'e04f75e8-d37b-42e4-8cf7-6127f35f3ed5', false);

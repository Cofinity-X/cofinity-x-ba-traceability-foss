...
values
    (${investigationSentId7}, 'BPNL000000000001', 'Problem is fixed' , current_timestamp - interval '6 days', 'Investigation on Philips RightHeadBulb due to broken fuse.', 'CLOSED', 'SENDER', null          , null             , current_timestamp - interval '1 hour', null);
...
values
    (${investigationNotificationSentId7a}, 'contractAgreementId', 'http://localhost:8082/api/qualitynotifications/receive', null                     , 'BPNL000SUPPLIER2', 'BPNL000000000001', ${investigationSentId7}, current_timestamp + interval '1 week', 2       , 'Hella'        , 'Philips'      , '3ac2239a-e63f-4c19-b3b3-e6a2e5a240da', 6     , current_timestamp - interval '6 days', current_timestamp - interval '1 hour', '749b31e9-9e73-4699-9470-dbee67ebc7a7', true);

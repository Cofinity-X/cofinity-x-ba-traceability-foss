...
values
    (${investigationSentId6}, 'BPNL000000000001', null         , current_timestamp - interval '7 days', 'Investigation on Osram O-BrakeLight due to strange noise.', 'CANCELED', 'SENDER', null          , null             , current_timestamp - interval '1 hour', null);
...
values
    (${investigationNotificationSentId6}, 'contractAgreementId', 'http://localhost:8082/api/qualitynotifications/receive', null                     , 'BPNL000SUPPLIER1', 'BPNL000000000001', ${investigationSentId6}, current_timestamp + interval '2 days', 3       , 'Hella'        , 'Osram'      , '3ac2239a-e63f-4c19-b3b3-e6a2e5a240da', 7     , current_timestamp - interval '7 days', current_timestamp - interval '1 hour', '749b31e9-9e73-4699-9470-dbee67ebc7a7', true);

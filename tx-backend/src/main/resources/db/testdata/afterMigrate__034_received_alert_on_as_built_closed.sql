...
values
    (${alertReceivedId5}, 'BPNL000SUPPLIER2', 'Issue has been resolved'        , current_timestamp - interval '6 days', 'Alert about P-BrakeLight'    , 'CLOSED', 'RECEIVER', null         , null          , null   , null);

...
values
    (${alertReceivedId2}, 'BPNL000SUPPLIER2', null        , current_timestamp - interval '3 days', 'Alert about Right P Light Bulbs', 'ACKNOWLEDGED', 'RECEIVER', null         , null          , null   , null);

...
class ReadReceivedInvestigationsWithSearchCriteriaControllerIT extends IntegrationTestSpecification {
    ...
    @Test
    void givenSortByCreatedDateFilterByCreatedDateProvided_whenGetInvestigations_thenReturnReceivedInvestigationsProperlySortedFilteredByCreatedDate() throws JoseException {
        // given
        String sortString = "createdDate,desc";
    ...
    @Test
    void givenSortByCreatedDateFilterBySendToNameProvided_whenGetInvestigations_thenReturnReceivedInvestigationsProperlySortedFilteredBySendToName() throws JoseException {
        // given
        String sortString = "createdDate,desc";
    ...
    @Test
    void givenSortByCreatedDateFilterByStatusProvided_whenGetInvestigations_thenReturnReceivedInvestigationsProperlySortedFilteredByStatus() throws JoseException {
        // given
        String sortString = "createdDate,desc";
    ...
    @Test
    void givenSortByCreatedDateFilterBySeverityProvided_whenGetInvestigations_thenReturnReceivedInvestigationsProperlySortedFilteredBySeverity() throws JoseException {
        // given
        String sortString = "createdDate,desc";
    ...
    @Test
    void givenSortByCreatedDateFilterByCreatedByProvided_whenGetInvestigations_thenReturnReceivedInvestigationsProperlySortedFilteredByCreatedBy() throws JoseException {
        // given
        String sortString = "createdDate,desc";
    ...
    @Test
    void givenSortByCreatedDateFilterByDescriptionProvided_whenGetInvestigations_thenReturnReceivedInvestigationsProperlySortedFilteredByDescription() throws JoseException {
        // given
        String sortString = "createdDate,desc";
    ...
    @Test
    void givenSortByCreatedDateFilterByDescriptionAndSendToProvided_whenGetInvestigations_thenReturnReceivedInvestigationsProperlySortedFilteredByDescriptionAndSendTo() throws JoseException {
        // given
        String sortString = "createdDate,desc";
        ...
        given()
                ...
                .contentType(ContentType.JSON)
                .when()
                .get("/api/investigations/received?page=0&size=10&sort=$sortString&filter=$filterString1&filter=$filterString2&filterOperator=AND"
                        .replace("$sortString", sortString)
    ...
    @Test
    void givenSortByCreatedDateFilterBySendToNameOrSendToProvided_whenGetInvestigations_thenReturnReceivedInvestigationsProperlySortedFilteredBySendToNameOrSendTo() throws JoseException {
        // given
        String sortString = "createdDate,desc";
        ...
        given()
                ...
                .contentType(ContentType.JSON)
                .when()
                .get("/api/investigations/received?page=0&size=10&sort=$sortString&filter=$filterString1&filter=$filterString2&filterOperator=OR"
                        .replace("$sortString", sortString)
                        .replace("$filterString1", filterString1)
                        .replace("$filterString2", filterString2))
                .then()

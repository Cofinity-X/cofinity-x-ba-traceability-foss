...
package org.eclipse.tractusx.traceability.notification.application.response;
...
class NotificationSeverityResponseTest {
    ...
    void givenSeverityResponse_whenCreateJson_thenSerializeProperly() throws JsonProcessingException {
        // given
        NotificationSeverityResponse input = NotificationSeverityResponse.LIFE_THREATENING;

 ...
 * the endpoints of {@link org.eclipse.tractusx.traceability.shelldescriptor.application.ShellDescriptorController}.
 */
class ShellDescriptorControllerAuthorizationIT extends IntegrationTestSpecification {

    private static final String ROOT = "/api/shelldescriptors";

...
export class DateValidators {
  ...
  public static min(minDate: Date): ValidatorFn {
    return (control: AbstractControl): ValidationErrors | null => {
      ...
      return isError ? { minDate: { actualValue: control.value.toString(), date: minDate } } : null;
    };
  }
  ...
  public static max(maxDate: Date): ValidatorFn {
    return (control: AbstractControl): ValidationErrors | null => {
      ...
      return isError ? { maxDate: { actualValue: control.value.toString(), date: maxDate } } : null;
    };
  }
}

...
With administrator authorization, the user is primarily able to configure the technical configuration of the EDC connection. From a technical perspective, the admin only has read authorization for existing quality alerts, investigations and parts.
...
Provides a fast overview about the amount of manufactured (my parts) and supplier and customer parts (shared parts) and batches, as well as the amount of open investigations and alerts.
Lists the five most recent received and open quality investigations and alerts to get an overview of the current state.

Open alerts and investigations are alert/ investigations with the with the status Created, Sent, Received, Acknowledged, Accepted, or Declined.
...
Use the burger menu to view user details, access the user manual, log out or change the language.
...
If you want to discard your changes, simply press you "ESC" - button, click anywhere else except in the dialog or close it explicitly with the close icon on the upper right of the dialog.
...
Clicking on the three dots menu on the right side of a quality investigation entry opens the quality investigation context menu. In the context menu, users can open the details of the given quality investigation. Supervisor can additionally update the status of the given quality investigation. Only possible status update actions will be shown in the menu.
...
You can select which columns are displayed by clicking on the settings icon in the top right corner of the table.
...
Clicking on the three dots menu on the right side of a quality alert entry opens the quality alert context menu. In the context menu, users can open the details of the given quality alert. Supervisor can additionally update the status of the given quality alert. Only possible status update actions will be shown in the menu.
